        ...
        <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a href="{{'asset/pages/sign-in.html'}}" class="nav-link text-body font-weight-bold px-0">
...
<!-- Vendor JS Files -->
<script src="{{asset('template/purecounter/purecounter_vanilla.js')}}"></script>
...
<script src="{{asset('template/typed.js/typed.min.js')}}"></script>
